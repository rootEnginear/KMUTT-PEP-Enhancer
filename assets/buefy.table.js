/*! Buefy v0.8.13 | MIT License | github.com/buefy/buefy */
      ...
      sortMultiColumn: function sortMultiColumn(column) {
        ...
        if (!this.backendSorting) {
          ...
          if (existingPriority) {
            ...
            // ! MANUAL OVERRIDE !
            // Sometimes `column.field` is `undefined` and got pushed into the array,
            // leads to unremovable object in the
            // I will do a further investigation and report to Buefy team ASAP.
            column.field && this.sortMultipleDataLocal.push({
              field: column.field,
              order: column.isAsc
            });
          }
